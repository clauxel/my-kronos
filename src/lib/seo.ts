...
const liveOrigin = 'https://kronos.rest'
...
const canonicalLinkId = 'kronos-canonical-link'
const structuredDataScriptId = 'kronos-structured-data'
...
export function buildSeoDocument(args: {
  ...
  if (routeView === 'pricing') {
    const title = 'Kronos AI Pricing | Pro Annual Forecast Workspace'
    const description =
      'Compare Kronos AI Starter, Pro, and Scale plans. Pro annual is selected by default and annual billing is 50% cheaper than monthly.'
    return {
      title,
      description,
      canonicalUrl,
  ...
  if (routeView === 'privacy') {
    ...
    const description = 'How Kronos AI handles analytics, checkout metadata, and managed-site interactions.'
    return {
      title,
      description,
      canonicalUrl,
  ...
  if (routeView === 'terms') {
    ...
    const description = 'Terms for using the Kronos AI managed site, hosted checkout, and related support services.'
    return {
      title,
      description,
      canonicalUrl,
  ...
  return {
    ...
    description: 'The requested Kronos AI page was not found.',
    canonicalUrl,
    robots: 'noindex,nofollow',
